...
function Profile(props) {
    ...
    return (
        ...
        >
            ...
            <div className="max-w-2xl w-full bg-white/30 backdrop-blur-lg shadow-2xl rounded-3xl p-10 relative overflow-hidden z-10">
                <div className="flex items-center space-x-8 mb-8">
                    ...
                    <div>
                        ...
                        <p className="text-blue-600 font-medium">Roll No:{user.studentId}</p>
                        <p className="text-gray-700">B.E <span className="font-semibold">{user.department}</span></p>
                    </div>
                </div>
